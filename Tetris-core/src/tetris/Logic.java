...
public class Logic {
	...
	public boolean moveDown() {
		...
		if (!isFigureFitsField()) {
			...
			Matcher match = new Matcher(fieldData, _state._field.getHeight(), _state._field.getWidth()  );
			match.Match();
			_state.setFigure(new Figure());
			return true;
		}
		return true;
	}
	...
	public boolean shuffle() {
		int i;
		i = _state._figure._data[0][0];
		_state._figure._data[0][0] = _state._figure._data[1][0];
		_state._figure._data[1][0] = _state._figure._data[2][0];
		_state._figure._data[2][0] = i;
		return true;
	}
